    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          style={{ borderTop: "1px solid #d4eadc" }}
        >
          <p className="text-xs pt-3" style={{ color: "#5a8a6a" }}>
            These cover exactly the concepts you will encounter. Spend time here
...
function ActiveMilestoneCard({
  ...
  function handleBeginMilestoneClick() {
    setIsOpening(true);
      ...
      <div className="p-6 space-y-6">
        ...
        {milestone.warmup_resources.length > 0 && (
          <p className="text-xs" style={{ color: "#7a9e8a" }}>
            📖 {milestone.warmup_resources.length} warm-up{" "}
            {milestone.warmup_resources.length === 1 ? "resource" : "resources"}{" "}
            waiting inside
          </p>
        )}
    ...
    >
      ...
      <div className="min-w-0 space-y-1">
        <div className="flex items-center gap-2">
          {isNext && (
            <span
              ...
              style={{ backgroundColor: "#f0ece6", color: "#8b7b6b" }}
            >
              Up next
            </span>
          )}
        ...
        <p
          ...
          style={{ color: isNext ? "#3c3c3c" : "#7b7b7b" }}
        >
          {milestone.title}
        </p>
        <p
          className="text-xs leading-relaxed"
          style={{ color: isNext ? "#6b6b6b" : "#9b9b9b" }}
        >
          {milestone.description}
        </p>
        {milestone.concepts_introduced.length > 0 && (
...
function CompleteMilestoneCard({ milestone }: { milestone: MilestoneRow }) {
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="text-sm font-semibold" style={{ color: "#3d6b4f" }}>
          {milestone.title}
        </p>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <div
          ...
          style={{ height: "4px", backgroundColor: "#e8e3da" }}
        >
          <div
      ...
      <div className="space-y-3">
        {milestones.map((m, i) => {
          ...
          return (
            <LockedMilestoneCard key={m.id} milestone={m} isNext={isNext} />
          );
        })}
      </div>
    </div>
